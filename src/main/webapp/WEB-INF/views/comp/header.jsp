...
<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container content-wrapper">
				...
				<a class="brand" href="<c:url value="/" />">吐槽
				...
				<div class="nav-collapse">
					<ul class="nav">
						<li id="nav-profiles">
							<a href="<c:url value="/profiles" />">神人</a>
						</li>
						<li id="nav-create">
							<a href="<c:url value="/spots/create" />">我要吐槽</a>
						</li>
						<li id="nav-apps">
							<a href="<c:url value="/apps" />" title="吐槽 -移动客户端">吐槽-移动客户端</a>
						</li>
					</ul>
				<c:choose> 
					...
					<c:otherwise>
						<ul class="nav pull-right">
							...
							<li class="divider-vertical"></li>
							<li id="nav-profile">
								<a href="<c:url value="/profiles/${signInUser.id}" />">我的吐槽</a></li>
							<li id="nav-dashboard">
								<a href="<c:url value="/dashboard" />">我的圈子</a></li>
							<li class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" href="#">
									消息
									<b class="caret"></b>
