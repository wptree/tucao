							...
							<form:form id="create-spot-form" cssClass="sign-in" modelAttribute="signUpUserVo" method="post">
								...
								<div class="row-fluid">
									<input class="span9" id="name" name="name" type="text" 
											placeholder="给个标题" autocomplete="off" value="<c:out value="${signUpUserVo.email}" />" />
								...
								<div class="row-fluid mt-10">
									<div class="input-append">
										<input id="full-addr-input" name="fullAddr" type="text" class="span3"
												placeholder="发生地点" autocomplete="off" value="<c:out value="${signUpUserVo.name}" />" />
										<span class="add-on">
								...
								<div class="row-fluid mt-10">
									 <button type="submit" class="btn btn-primary btn-large">吐槽一下</button>
